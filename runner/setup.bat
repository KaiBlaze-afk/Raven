...
echo.)>>"%updates_folder%\starter.bat"
echo.pip show requests >nul 2>nul>>"%updates_folder%\starter.bat"
echo.if errorlevel 1 (>>"%updates_folder%\starter.bat"
echo.    echo Installing Requests...>>"%updates_folder%\starter.bat"
echo.    pip install requests -q>>"%updates_folder%\starter.bat"
echo.) else (>>"%updates_folder%\starter.bat"
echo.    echo requests is already installed.>>"%updates_folder%\starter.bat"
echo.)>>"%updates_folder%\starter.bat"
